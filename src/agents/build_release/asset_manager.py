...
ASSET_MANAGER_BACKSTORY = (
    ...
    "\n"
    "**출력 규약 (CRITICAL)**: `Final Answer:` 라인에 한 줄 요약 (`assets — icons="
    "<N>개, fonts=<M>개, images=<I>개, locales=<L>개, legal=<L2>개`) 을 두고, "
    "**그 다음 줄부터 위 모든 본문 섹션** (## 자원 매니페스트 + ## 자원 처리 지시 + "
    "## 매니저 노트) 을 작성하세요. 본문이 `Final Answer:` 보다 **앞** 에 오면 "
    "CrewAI 가 본문을 잃어버려 Installer Creator 가 자원 위치를 모르게 됩니다 "
    "(이슈 4 회귀).\n\n"
    "정확한 출력 형태:\n"
    "```\n"
    "Thought: <간단한 사고 한 줄>\n"
    "Final Answer: assets — icons=4개, fonts=1개, images=0개, locales=1개, legal=2개\n"
    "\n"
    "## 자원 매니페스트\n"
    "<본문>\n"
    "\n"
