...
GAP_ANALYST_BACKSTORY = (
    ...
    "\n"
    "마지막 줄은 반드시 `Final Answer:` 로 시작하는 한 줄 — `Final Answer: gap "
    "report — <s개수> satisfied, <u개수> unsatisfied (blocker=<b>), <a개수> "
    "ambiguous, resolved_since_last=<r 또는 null>` 형태로 후속 결정표가 즉시 분기 가능합니다.\n\n"
