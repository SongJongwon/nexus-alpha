...
class TestEnableRvDefaultOff:
    ...
    def test_node_returns_empty_when_enable_rv_false(self) -> None:
        ...
        state = {"enable_rv": False, "enable_smoke": False, "enable_packageability": False, "chain_result": None}
    ...
    def test_node_returns_empty_when_enable_rv_missing(self) -> None:
        ...
        state = {"enable_smoke": False, "enable_packageability": False, "chain_result": None}
        result = _node_runtime_verify(state)
        assert result == {}
...
class TestSilentFailDetection:
    ...
    def test_silent_fail_sets_failure_detected_true(
        ...
        state = {"enable_rv": True, "enable_smoke": False, "enable_packageability": False, "chain_result": chain_result}
        result = _node_runtime_verify(state)
